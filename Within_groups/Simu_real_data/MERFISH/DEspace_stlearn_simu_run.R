...
for (Perm_i in Perm_i_min:Perm_i_max){
    ...
    stLearn_results <- read.csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC", FC, "/stlearn/stlearn_clusters_MERFISH_FC", FC, "_Perm_", Perm_i, ".txt"), row.names=1)
    ...
    save(DESpace_stlearn.res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC", FC, "/DESpace_stlearn/Perm_", Perm_i,"_DESpace_stlearn_MERFISH.RData"))
