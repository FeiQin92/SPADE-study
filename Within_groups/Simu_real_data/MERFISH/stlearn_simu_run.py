...
for FC in ["1.5", "2", "2.5", "3", "3.5"]:
    ...
    Count=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/count_MERFISH_FC", FC, ".spa.txt"),sep=" ",header=0, na_filter=False, index_col=0)
    ...
    for Perm_i in range(0, 101): 
        ...
        outpath=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC", FC, "/stlearn/stlearn_clusters_MERFISH_FC", FC, "_Perm_", Perm_i, ".txt")
