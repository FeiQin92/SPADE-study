...
Perm_i=as.numeric(args[1])

print(paste0("FC=", FC))

# the first 50/200 genes are marker genes
readcounts <- as.matrix(read.table(file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/count_MERFISH_FC", FC, ".txt")))
info <- read.table(file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/info_MERFISH_FC", FC, ".txt"))
...
save(SPARK_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC",FC,"/SPARK/Perm_", Perm_i,"_SPARK_MERFISH.RData"))
...
save(Est, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC",FC,"/SPADE/Perm_", Perm_i,"_SPADE_Est_MERFISH.RData"))

res_all_SPADE <- SPADE_test(object=regdata, location=info, para=Est)
save(res_all_SPADE, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC",FC,"/SPADE/Perm_", Perm_i,"_SPADE_Test_MERFISH.RData"))
...
save(MERINGUE_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC",FC,"/MERINGUE/Perm_", Perm_i,"_MERINGUE_MERFISH.RData"))
...
save(DESpace_BayesSpace_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MERFISH/FC",FC,"/DESpace_BayesSpace/Perm_", Perm_i,"_DESpace_BayesSpace_MERFISH.RData"))
