...
readcounts <- as.matrix(read.table(file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/count_SeqFISH_FC", FC, ".txt")))
info <- read.table(file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/info_SeqFISH_FC", FC, ".txt"))
...
for (Perm_i in Perm_i_min:Perm_i_max){
  ...
  save(SPARK_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/FC",FC,"/SPARK/Perm_", Perm_i,"_SPARK_SeqFISH.RData"))
  save(SPADE_list, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/FC",FC,"/SPADE/Perm_", Perm_i,"_SPADE_SeqFISH.RData"))
  save(MERINGUE_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/FC",FC,"/MERINGUE/Perm_", Perm_i,"_MERINGUE_SeqFISH.RData"))
  save(DESpace_BayesSpace_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/FC",FC,"/DESpace_BayesSpace/Perm_", Perm_i,"_DESpace_BayesSpace_SeqFISH.RData"))
