...
for FC in ["1.5", "2", "2.5", "3", "3.5"]:
    ...
    spatial=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/info_SeqFISH_200_FC", FC, "_Perm1000.txt"),sep="\t",header=None, na_filter=False, index_col=0)

    for Perm_i in range(0, 1001): 
        print(paste0("Perm_i ############ ", Perm_i))
	
        adata=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/count_SeqFISH_FC", FC, ".spa.txt"),sep=" ",header=0, na_filter=False, index_col=0)
        ...
        outpath=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/FC", FC, "/SpaGCN/SpaGCN_SeqFISH_FC", FC, "_Perm_", Perm_i, ".txt")
        de_genes_info.to_csv(outpath, sep='\t', index=False)

        # Save the list of adata objects as a .RData file
        # robjects.r['save'](r_adata_list, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/SeqFISH/FC", FC, "/SpaGCN/SpaGCN_SeqFISH_FC",FC,".RData"))
