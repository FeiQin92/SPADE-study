...
for FC in ["1.5", "2", "2.5", "3", "3.5"]:
    ...
    Count=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MOB/count_MOB_FC", FC, ".spa.txt"),sep=" ",header=0, na_filter=False, index_col=0)
    Count=Count.transpose()

    spatial_all=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MOB/info_MOB_200_FC", FC, "_Perm1000.txt"),sep="\t",header=None, na_filter=False, index_col=0)
    ...
    for Perm_i in range(0, 1001): 
        ...
        outpath=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/Simu_real_data/MOB/FC", FC, "/stlearn/stlearn_clusters_MOB_FC", FC, "_Perm_", Perm_i, ".txt")
