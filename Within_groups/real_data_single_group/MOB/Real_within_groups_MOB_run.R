...
readcounts <- as.matrix(read.table(file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/MOB/count_MOB.spa.txt"), header=T))
info <- read.table(file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/MOB/info_MOB.spa.txt"), row.names=1)
...
for (Perm_i in Perm_i_min:Perm_i_max){
   ...
   SPADE_list <- list(Est, res_all_SPADE)
    ...
    save(SPARK_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/MOB/SPARK/Perm_", Perm_i,"_SPARK_MOB.RData"))
    save(SPADE_list, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/MOB/SPADE/Perm_", Perm_i,"_SPADE_MOB.RData"))
    save(MERINGUE_res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/MOB/MERINGUE/Perm_", Perm_i,"_MERINGUE_MOB.RData"))
    save(DESpace_BayesSpace.res, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/MOB/DESpace_BayesSpace/Perm_", Perm_i,"_DESpace_BayesSpace_MOB.RData"))
