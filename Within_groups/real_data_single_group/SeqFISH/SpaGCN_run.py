...
spatial=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/SeqFISH/info_SeqFISH_Perm1000.txt"),sep="\t",header=None, na_filter=False, index_col=0)

for Perm_i in range(0, 1001): 
    print(paste0("Perm_i ############ ", Perm_i))
	
    adata=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/SeqFISH/count_SeqFISH.spa.txt"),sep=" ",header=0, na_filter=False, index_col=0)
    ...
    outpath=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/SeqFISH/SpaGCN/SpaGCN_SeqFISH_Perm_", Perm_i, ".txt")
    de_genes_info.to_csv(outpath, sep='\t', index=False)

    # Save the list of adata objects as a .RData file
    # robjects.r['save'](r_adata_list, file=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/SeqFISH/FC", FC, "/SpaGCN/SpaGCN_SeqFISH_FC",FC,".RData"))
