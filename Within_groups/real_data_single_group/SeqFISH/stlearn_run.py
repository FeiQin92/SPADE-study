...
Count=pd.read_csv(paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/SeqFISH/count_SeqFISH.spa.txt"),sep=" ",header=0, na_filter=False, index_col=0)
...
for Perm_i in range(0, 1001): 
    ...
    outpath=paste0("/gpfs/gsfs12/users/qinf2/GuoshuaiCai/SPADE/real_data_single_group/SeqFISH/stlearn/stlearn_clusters_SeqFISH_Perm_", Perm_i, ".txt")
